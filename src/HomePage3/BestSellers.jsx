...
const BestSellers = () => {
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <RadioGroup defaultValue="Buffet Vegas">
                {['Fish Vegetables', 'Buffet Vegas', 'Fish Fry Grilled', 'Tasty Snacks', 'Smoked Chicken'].map((item) => (
                  <FormControlLabel
                    key={item}
                    value={item}
                    control={<Radio sx={{ color: '#FFD40D', '&.Mui-checked': { color: '#FFD40D' } }} />}
                    label={item}
                    sx={{
 ...
 <Box component="img" src={ImageAssets.junk} alt="Buffet" sx={{ width: '25%', borderRadius: 2 }} />
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              <Box>
                <Typography sx={{ fontWeight: 600, fontSize: 18, mb: 1 }}>Buffet Vegas</Typography>
                ...
                <Typography sx={{ fontWeight: 'bold', fontSize: 16, color: '#E91E63', mt: 1 }}>
                  $10.85 <span style={{ textDecoration: 'line-through', color: '#aaa', fontWeight: 400 }}>$14.85</span>
                </Typography>
                <Button
                  variant="contained"
                  sx={{
